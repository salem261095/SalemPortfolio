...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  return renderTemplate(_a || (_a = __template(['<html lang="ar" dir="rtl" class="h-full min-h-screen"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/assets/favicon.ico"><meta name="generator"', ">", '<!-- VERY IMPORTANT: allow pages to inject their own SEO here --><script defer data-domain="salem-des.com" src="https://plausible.io/js/script.file-downloads.hash.outbound-links.pageview-props.tagged-events.js"><\/script>', "", '</head> <body class="min-h-screen bg-gray-100 text-gray-900 dark:bg-zinc-800 dark:text-white font-kunkun"> ', " </body></html>"])), addAttribute(Astro2.generator, "content"), renderSlot($$result, $$slots["head"]), renderScript($$result, "H:/Salem-Desv6/SalemPortfolio/src/layouts/Layout.astro?astro&type=script&index=0&lang.ts"), renderHead(), renderComponent($$result, "Main", $$Main, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Header", $$Header, {})} ${renderSlot($$result2, $$slots["default"])} ${renderComponent($$result2, "Footer", $$Footer, {})} ` }));
